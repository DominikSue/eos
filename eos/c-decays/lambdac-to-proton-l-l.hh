...
#ifndef EOS_GUARD_EOS_C_DECAYS_LAMBDA_C_TO_PROTON_LEPTON_LEPTON_HH
#define EOS_GUARD_EOS_C_DECAYS_LAMBDA_C_TO_PROTON_LEPTON_LEPTON_HH 1
...
namespace eos
{
     ...
     */
    class LambdaCToProtonLeptonLepton : public ParameterUser,
                                        public PrivateImplementationPattern<LambdaCToProtonLeptonLepton>
    {
    public:
