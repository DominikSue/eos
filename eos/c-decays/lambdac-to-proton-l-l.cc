...
namespace eos
{
    ...
    struct Implementation<LambdaCToProtonLeptonLepton>
    {
        ...
        inline lambdac_to_proton_l_l::AngularObservables differential_angular_observables(const double &q2)
        {
            return lambdac_to_proton_l_l::AngularObservables{_differential_angular_observables(q2)};
        }

        inline lambdac_to_proton_l_l::AngularObservables integrated_angular_observables(const double &q2_min, const double &q2_max)
        {
    ...
    Implementation<LambdaCToProtonLeptonLepton>::options
    {
        {"l", {"e", "mu", "tau"}, "mu"}
    };
